$(function() {
    ...
    var container = document.querySelector("#pictureBoxCover > div:nth-child(3)");
    var photo = document.querySelector("#pictureBoxCover form input[type='file']");
    console.log(container)
    console.log(photo)
    photo.addEventListener("change", readURL(this));
    })
